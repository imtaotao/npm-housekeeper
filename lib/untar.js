// Fork from "https://github.com/InvokIT/js-untar"
  ...
  untarBuffer(arrayBuffer) {
    try {
      ...
      while (tarFileStream.hasNext()) {
        ...
        this.postMessage({ type: "extract", data: file });
      }
...
exports.untar = function (arrayBuffer) {
  return new Promise((resolve, reject) => {
    ...
    const worker = new UntarWorker(callback);
    worker.onmessage({ type: "extract", buffer: arrayBuffer });
  });
};
