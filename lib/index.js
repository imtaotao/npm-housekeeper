...
exports.Installer = class Installer {
  ...
  async generatePackages(addPackages, removePackages) {
    ...
    console.log("2. Remove old dependencies...");
    await each(removePackages, "remove");
    console.log("3. Downloading dependencies...");
    await each(addPackages, "add", this.download.bind(this));
  }

  async startInstall() {
    console.log("1. Analyzing dependencies...");
    ...
    console.log("4. Generate dependency tree...");
